...
class PtfloWidget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        quote_setting_button = QtWidgets.QPushButton("使用独立股票行情")
        quote_setting_button.clicked.connect(self.set_quote_gateway)
        form.addRow(quote_setting_button)

        self.setLayout(form)

    def set_quote_gateway(self):
        # set stock universe quote gateway
        self.algo_engine.set_quote_gateway_name('quote')
